...
con =
    ...
    mob10 integer, armor TEXT, gold integer, defxp integer, maxhp integer, zat2 integer,
     profa text,buff integer,srec text, Varnish integer,rbfight integer,mp integer,
     maxmp integer,hpbanka integer,mpbanka integer,mob11 integer,mob12 integer,dinoq integer,nosq integer,
     aliq integer,bufq integer,lionq integer,bearq integer,mobr integer,mobra integer)""")
...
async def start(message: types.Message):
    ...
    if data is None:
        ...
        cur.executescript(f'INSERT INTO players VALUES ("{user_id}","{nick}",0,1,1,5,0,140,0,0,10000'
